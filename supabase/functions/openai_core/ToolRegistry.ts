export const availableTools = [
  // Finanças
  { type: "function", function: { name: "criar_despesa", description: "Registra nova despesa no sistema.", parameters: { type: "object", properties: { description: { type: "string" }, amount: { type: "number" }, date: { type: "string" }, category_id: { type: "string" } }, required: ["description", "amount"] } } },
  ...
  { type: "function", function: { name: "criar_receita", description: "Registra nova receita.", parameters: { type: "object", properties: { description: { type: "string" }, amount: { type: "number" }, date: { type: "string" }, category_id: { type: "string" } }, required: ["description", "amount"] } } },
  ...
  // Agenda
  { type: "function", function: { name: "criar_evento", description: "Cria compromisso na agenda.", parameters: { type: "object", properties: { title: { type: "string" }, start_time: { type: "string" }, end_time: { type: "string" } }, required: ["title", "start_time"] } } },
  { type: "function", function: { name: "editar_evento", description: "Edita compromisso existente.", parameters: { type: "object", properties: { event_id: { type: "string" }, title: { type: "string" }, start_time: { type: "string" } }, required: ["event_id"] } } },
  ...
  { type: "function", function: { name: "consultar_agenda", description: "Visualiza os compromissos agendados num dia ou período.", parameters: { type: "object", properties: { date: { type: "string" } }, required: [] } } },
