export const availableTools = [
  ...
  // Agenda
  { type: "function", function: { name: "criar_evento", description: "Cria compromisso na agenda.", parameters: { type: "object", properties: { title: { type: "string" }, start_time: { type: "string", description: "Obrigatório formato ISO 8601. Exemplo: 2026-07-01T10:00:00Z" }, end_time: { type: "string", description: "Opcional. Formato ISO 8601. Exemplo: 2026-07-01T11:00:00Z" }, description: { type: "string" }, location: { type: "string" } }, required: ["title", "start_time"] } } },
