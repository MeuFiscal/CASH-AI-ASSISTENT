  ...
  return (
    <DashboardCard className="p-0 border-[#10B981]/20 bg-gradient-to-br from-[#181C28] to-[#0B1221] relative overflow-hidden group">
      ...
      <div className="p-6 md:p-8 flex flex-col items-center justify-center text-center h-full min-h-[220px]">
        ...
        <h3 className="text-[15px] font-semibold text-white mb-2">Metas Financeiras</h3>
        <p className="text-[13px] text-[#A8B3CF] leading-relaxed max-w-[250px]">
          Defina suas metas financeiras para que eu possa ajudá-lo a alcançá-las mais rápido.
        </p>
      </div>
    </DashboardCard>
  );
